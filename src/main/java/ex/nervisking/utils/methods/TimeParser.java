...
public final class TimeParser {
    ...
    @ToUse(
            value = "Convierte un string de tiempo personalizado a ticks (1 tick = 50ms).",
            params = {
                    "input: Cadena que representa el tiempo en formato flexible. ",
                    "Soporta: t (ticks), ms (milisegundos), s (segundos), m (minutos), h (horas), d (días). ",
                    "Ejemplos: '1d10m', '5m;35s;4t', '1h 30m 20s'."
            },
            returns = "Tiempo total en ticks.",
            usedFor = "Conversión de tiempo a ticks para eventos o tareas en Minecraft.",
            notes = {
                    "Se pueden usar separadores como espacios, comas, puntos o punto y coma."
            },
            Throws = "Lanza IllegalArgumentException si el formato no es válido."
    )
    public static long parseToTicks(String input) throws IllegalArgumentException  {
