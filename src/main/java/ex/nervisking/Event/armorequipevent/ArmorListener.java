package ex.nervisking.Event.armorequipevent;
...
import ex.nervisking.Event.armorequipevent.ArmorEquipEvent.EquipMethod;
	...
	public final void inventoryClick(final InventoryClickEvent e){
		...
		if(shift){
			...
			if(numberkey){
				...
				if(ExApi.serverVersion.serverVersionGreaterEqualThan(serverVersion,ServerVersion.v1_9_R1)){
	...
	public void playerInteractEvent(PlayerInteractEvent e){
		...
		if(e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK){
			...
			if(newArmorType != null && !isHead(e.getItem())){
				...
				if(ExApi.serverVersion.serverVersionGreaterEqualThan(serverVersion,ServerVersion.v1_20_R1)){
					switch(newArmorType){
						case HELMET:
